...
export function About() {
    ...
    return (
        <div className="items-center min-h-screen px-6 mx-auto align-middle mt-36 md:mt-0 md:flex md:max-w-4xl pb-36 md:pb-0">
            ...
            >
                <h1 className="my-10 md:text-4xl">Creating websites with a focus on  <br /> <span className="text-secondary"> best practices and quality standards.</span></h1>
                <p>Experienced professional dedicated to delivering high-quality results.Demonstrated track record of successful project completions, contributing to a solid foundation of expertise in the field.</p>
